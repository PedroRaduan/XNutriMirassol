  ...
  return (
    <div className="container-x grid min-h-[70vh] place-items-center py-12">
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-bold tracking-tight md:text-4xl">Criar conta</h1>
        <p className="mt-3 text-[var(--muted)]">Compre mais rápido, salve endereços e acompanhe seu histórico.</p>
        <div className="mt-6">
          <RegisterForm />
        </div>
        <p className="mt-5 text-sm text-[var(--muted)]">
          Já tem conta? <Link href="/login" className="font-semibold text-[var(--brand)]">Entrar</Link>
        </p>
      </div>
    </div>
  );
