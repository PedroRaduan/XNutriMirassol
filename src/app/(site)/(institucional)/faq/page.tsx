  ...
  return (
    <StaticPage
      ...
      sections={[
        ...
        { title: "Como funciona o pagamento?", body: "O checkout usa PagBank para PIX e cartão. Após a confirmação do pagamento, o status do pedido pode ser atualizado automaticamente." },
