...
export const metadata: Metadata = {
  ...
  icons: {
    apple: [{ url: "/xnutri-admin-180.png", sizes: "180x180", type: "image/png" }],
  },
...
export default async function ProtectedAdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const canInstallAdminApp = admin.adminRole === "ADMIN" && !isDemo;
          ...
          <div className="min-w-0">
            <header className="admin-topbar mb-5 flex flex-col gap-3 rounded-lg p-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-col gap-2 sm:items-end">
                {canInstallAdminApp ? <AdminAppInstall /> : null}
                <form action={logout}>
