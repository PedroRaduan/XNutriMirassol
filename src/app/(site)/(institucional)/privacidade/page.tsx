  ...
  return (
    <StaticPage
      ...
      sections={[
        ...
        { title: "Pagamentos", body: "Dados sensíveis de pagamento são processados pelo PagBank. A loja armazena apenas identificadores, status e metadados necessários para conciliação." },
