  ...
  return (
    <div className="container-x grid min-h-[70vh] place-items-center py-12">
      <div className="w-full max-w-md">
        <h1 className="text-3xl font-bold tracking-tight md:text-4xl">Recuperar senha</h1>
        <p className="mt-3 text-[var(--muted)]">Informe seu e-mail para iniciar a recuperação segura da conta.</p>
        <div className="mt-6">
          <RecoveryForm />
        </div>
        <Link href="/login" className="mt-5 inline-block text-sm font-semibold text-[var(--brand)]">Voltar para login</Link>
      </div>
    </div>
  );
}
