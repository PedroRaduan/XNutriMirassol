    ...
    <div>
      <div className="admin-page-heading mb-6">
        ...
        <p className="admin-page-copy mt-2 text-sm">
          Dados gerais da loja, atendimento, pagamento, entrega e mensagem padrão de retirada.
        </p>
      </div>
      ...
      <AdminActionForm actionName="updateStoreSettings" className="grid gap-6">
        <section className="surface p-5">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            ...
            <label className="text-sm font-black">Razão social<input className="field mt-2" name="legalName" defaultValue={getText(store, "legalName")} /></label>
            ...
            <label className="text-sm font-black md:col-span-2">Endereço<input className="field mt-2" name="address" defaultValue={getText(store, "address")} /></label>
            ...
            <label className="text-sm font-black md:col-span-2">Horário de funcionamento
